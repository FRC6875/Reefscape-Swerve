...
public class AutoElevatorL2 extends Command {
  ...
  public AutoElevatorL2(ElevatorSubsystem elevatorSubsystem, LaserSubsystem laserSubsystem,double dist, double laserDist) {
  ...
  @Override
  public void execute() {
    m_elevatorSubsystem.moveToPosition(-6);
  }
