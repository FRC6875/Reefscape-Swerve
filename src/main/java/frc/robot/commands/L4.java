...
public class L4 extends ParallelCommandGroup {
  ...
  public L4(ElevatorSubsystem elevatorSubsystem, IntakeSubsystem intakeSubsystem, IntakeWheelsSubsystem intakeWheelsSubsystem, DoubleSupplier elevatorPosition, DoubleSupplier holderPosition) {
    addCommands(
