...
public class AutoElevatorL3 extends Command {
  ...
  public AutoElevatorL3(ElevatorSubsystem elevatorSubsystem, LaserSubsystem laserSubsystem,double dist, double laserDist) {
  ...
  @Override
  public void execute() {
    m_elevatorSubsystem.moveToPosition(-7);
  }
