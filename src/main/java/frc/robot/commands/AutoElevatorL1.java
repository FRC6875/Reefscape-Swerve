...
public class AutoElevatorL1 extends Command {
  ...
  public AutoElevatorL1(ElevatorSubsystem elevatorSubsystem, LaserSubsystem laserSubsystem,double dist, double laserDist) {
  ...
  @Override
  public void execute() {
    m_elevatorSubsystem.moveToPosition(-5);
  }
